...
public class BluetoothStackBlueZ implements BluetoothStack {
	...
	private final static String LIBRARY_NAME = "bluecove";
	 ...
	 */
	public static BluetoothStackBlueZ getInstance() {
		if( instance==null) {
			synchronized(BluetoothStackBlueZ.class) {
				instance = new BluetoothStackBlueZ();
			}
		}
		return instance;
	}
