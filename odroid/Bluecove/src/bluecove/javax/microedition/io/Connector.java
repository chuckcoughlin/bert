 ...
 */ 
package bluecove.javax.microedition.io;
...
import bluecove.bluetooth.MicroeditionConnector;
...
public class Connector {
	private final static String CLSS = "Connector";
	...
	public static Connection open(String name) throws IOException {
		LOGGER.info(String.format("%s.open: using BlueCove javax.microedition.io.Connector",CLSS));
