...
import bluecove.bluetooth.SelectServiceHandler;
...
public class DiscoveryAgent {
	private final static String CLSS = "DiscoveryAgent";
	...
	public boolean cancelInquiry(DiscoveryListener listener) {
		...
		LOGGER.info(String.format("%s.cancelInquiry", CLSS));
	...
	public boolean cancelServiceSearch(int transID) {
		LOGGER.info(String.format("%s.cancelServiceSearch: transId %d", CLSS,transID));
