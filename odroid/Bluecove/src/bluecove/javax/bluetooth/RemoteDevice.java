...
public class RemoteDevice {
	private final static String CLSS = "RemoteDevice";
	...
	protected RemoteDevice(String address) {
		...
		LOGGER.info(String.format("%s: new RemoteDevice (%s)", CLSS,address));
		...
		try {
			...
			throw (RuntimeException) new RuntimeException("Can't initialize bluetooth support "+e.getLocalizedMessage());
		}
	 ...
	 */
	public boolean authorize(bluecove.javax.microedition.io.Connection conn) throws IOException {
	 ...
	 *                connection to this <code>RemoteDevice</code>
	 */
	public boolean encrypt(bluecove.javax.microedition.io.Connection conn, boolean on) throws IOException {
	 ...
	 *                if <code>conn</code> is closed
	 */
	public boolean isAuthorized(bluecove.javax.microedition.io.Connection conn) throws IOException {
