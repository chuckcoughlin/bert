 ...
 */
package bluecove.javax.bluetooth;

import java.util.Hashtable;

import bluecove.bluetooth.BlueCoveLocalDeviceProperties;
import bluecove.bluetooth.BluetoothConnectionNotifierServiceRecordAccess;
import bluecove.bluetooth.BluetoothConsts;
import bluecove.bluetooth.BluetoothStack;
import bluecove.bluetooth.BluetoothStackBlueZ;
import bluecove.bluetooth.RemoteDeviceHelper;
import bluecove.bluetooth.ServiceRecordsRegistry;
...
public class LocalDevice {
    ...
    private static synchronized LocalDevice getLocalDeviceInstance() throws BluetoothStateException {
        BluetoothStack stack = BluetoothStackBlueZ.getInstance();
    ...
    public static String getProperty(String property) {
    	...
    	if (BluetoothConsts.PROPERTY_BLUETOOTH_API_VERSION.equals(property)) {
    		...
    		return (((stack.getFeatureSet() & BluetoothStack.FEATURE_L2CAP) != 0) ? BluetoothStack.TRUE : BluetoothStack.FALSE);
    	} else if (BlueCoveLocalDeviceProperties.LOCAL_DEVICE_PROPERTY_FEATURE_SERVICE_ATTRIBUTES.equals(property)) {
    		return (((stack.getFeatureSet() & BluetoothStack.FEATURE_SERVICE_ATTRIBUTES) != 0) ? BluetoothStack.TRUE : BluetoothStack.FALSE);
    	} else if (BlueCoveLocalDeviceProperties.LOCAL_DEVICE_PROPERTY_FEATURE_SET_DEVICE_SERVICE_CLASSES.equals(property)) {
    		return (((stack.getFeatureSet() & BluetoothStack.FEATURE_SET_DEVICE_SERVICE_CLASSES) != 0) ? BluetoothStack.TRUE : BluetoothStack.FALSE);
    	...
    	return stack.getLocalDeviceProperty(property);
    }
