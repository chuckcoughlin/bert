...
import bc.javax.bluetooth.gcf.socket.ServerSocketConnection;
import bc.javax.microedition.io.Connection;
import bc.javax.microedition.io.ConnectionNotFoundException;
import bc.javax.microedition.io.Connector;
import bc.javax.microedition.io.InputConnection;
import bc.javax.microedition.io.OutputConnection;
...
public abstract class MicroeditionConnector {
	...
	private static Connection openImpl(String name, int mode, boolean timeouts, boolean allowServer) throws IOException {
		...
		if (schemeBluetooth) {
			bluetoothStack = BluetoothManager.getInstance().getStack();
		}
		...
		if (scheme.equals(BluetoothConsts.PROTOCOL_SCHEME_TCP_OBEX)
			...
			obexConnectionParams.timeout = BlueCoveImpl.getConfigProperty(
					BlueCoveConstants.PROPERTY_OBEX_TIMEOUT, OBEXConnectionParams.DEFAULT_TIMEOUT);
			obexConnectionParams.mtu = BlueCoveImpl.getConfigProperty(BlueCoveConstants.PROPERTY_OBEX_MTU,
