...
command:
    ...
    | List Article? Article? (Motors|Limbs|Appendages|Bones)      # bodyPartListQuestion
...
question:
    ...
    | (What Are|Tell Me) Article? Names Of Article? (Motors|Limbs|Appendages|Bones)   # bodyPartNamesQuestion
