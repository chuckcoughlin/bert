...
class NamedSocket {
     ...
     */
    fun shutdown() {
        chuckcoughlin.bert.common.controller.NamedSocket.Companion.LOGGER.info(String.format("%s.shutdown: %s closing sockets ...",
            chuckcoughlin.bert.common.controller.NamedSocket.Companion.CLSS, name))
        try {
        ...
        try {
            if (`in` != null) {
                ...
                while (text == null) {
                    ...
                    chuckcoughlin.bert.common.controller.NamedSocket.Companion.LOGGER.info(String.format("%s.readLine: got null, retrying",
                        chuckcoughlin.bert.common.controller.NamedSocket.Companion.CLSS
                    ))
    ...
    companion object {
        ...
        private val LOGGER = Logger.getLogger(chuckcoughlin.bert.common.controller.NamedSocket.Companion.CLSS)
