...
object HandSolver {
    ...
    fun place(msg: MessageBottle,list:MutableList<MessageBottle>): String {
        ...
        val current = ForwardSolver.computeLocation(msg.appendage)
        val elbow = ForwardSolver.computeLocation(elbowJoint)
        val shoulder = ForwardSolver.computeLocation(shoulder_z)
