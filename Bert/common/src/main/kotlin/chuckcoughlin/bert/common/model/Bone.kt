 ...
 */
enum class Bone {
    CERVICAL, LEFT_CLAVICLE, LEFT_FOOT, LEFT_FOREARM, LEFT_ILLIUM,LEFT_HIP_SOCKET, LEFT_SHIN, LEFT_SHOULDER_SOCKET, LEFT_THIGH, LEFT_UPPER_ARM,
    LOWER_SPINE, LUMBAR, NECK, PELVIS, RIGHT_CLAVICLE, RIGHT_FOOT, RIGHT_FOREARM, RIGHT_ILLIUM, RIGHT_HIP_SOCKET, RIGHT_SHIN, RIGHT_SHOULDER_SOCKET,
