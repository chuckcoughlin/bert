 ...
 */
class CommandController(req : Channel<MessageBottle>,rsp: Channel<MessageBottle>) :Controller {
    ...
    fun sendStartupMessage(handler:CommandMessageHandler) {
        ...
        val skeleton = TextUtility.stripNewLines(ForwardSolver.jointLinksToJson() )
