...
object ChainTest {
    ...
    fun execute() {
        ...
        */
        ...
        val root = tree.getJointPosition(Joint.IMU)   // IMU
        root.setOrientation(0.0,0.0,0.0)
        var jp = tree.computeJointPosition(Joint.ABS_Y)
        ...
        jp = tree.computeJointPosition(Joint.ABS_Y)
        ...
        tree.setJointsToHome()
        jp = tree.computeJointPosition(Joint.ABS_Y)
        println(String.format("\t%s (12.0,0.0,62 | 180,0,180] : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.ABS_X)
        println(String.format("\t%s (12.0,0.0,70.0) [90,90,0] : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.ABS_Z)
        println(String.format("\t%s (0.0,0.0,121.6) [0,90,90] : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.CHEST_Y)
        println(String.format("\t%s (2.8,0.0,201.5) [0,180,0] : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.CHEST_X)
        println(String.format("\t%s (2.8,0.0,193.5) [90,90,0] : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.NECK_Z)
        println(String.format("\t%s (7.8,0.0,277.5) [0,90,90]  : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.NECK_Y)
        println(String.format("\t%s (27.8,0.0,297.5) [0,0,0]   : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.NOSE)
        println(String.format("\t%s (42.8,0.0,337.5) [0,0,0]     : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_EAR)
        println(String.format("\t%s (57.8,-62.0,352.5) [90,90,0]   : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_EAR)
        println(String.format("\t%s (57.8,62.0,352.5) [90,90,180]: (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_EYE)
        println(String.format("\t%s (27.8,-32.0,352.5) [0,0,0]     : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_EYE)
        println(String.format("\t%s (27.8,32.0,352.5) [0,0,0]   : (%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        println("        BACK JOINTS/APPENDAGES VERIFIED ####################")
        println("======== Test Joints along upper body sides - home pose")
        jp = tree.computeJointPosition(Joint.RIGHT_SHOULDER_Y)
        println(String.format("\t%s(6.8, 77.1,243.5) [0,0,180]:(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_SHOULDER_Y)
        println(String.format("\t%s (6.8,-77.1,243.5) [0,0,180]:(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_SHOULDER_X)
        println(String.format("\t%s(6.8, 105.5,243.5) [90,90,180]:(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_SHOULDER_X)
        println(String.format("\t%s (6.8,-105.5,243.5) [90,90,180]:(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_SHOULDER_Z)
        println(String.format("\t%s(-11.7, 105.5,160.5) [0,90,90]:(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_SHOULDER_Z)
        println(String.format("\t%s (-11.7,-105.5,160.5) [0,90,90]:(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_ELBOW_Y)
        println(String.format("\t%s (-21.7,105.5,79.3) [0,0,180]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_ELBOW_Y)
        println(String.format("\t%s (-21.7,-105.5,79.3) [0,0,180]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_FINGER)
        println(String.format("\t%s (-28.6,100.5,-41.7) [90,90,180] :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_FINGER)
        println(String.format("\t%s (-28.6,-100.5,-41.7) [90,90,180]:(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        println("        UPPER JOINTS/APPENDAGES VERIFIED ####################")
        println("======== Test Joints along lower body sides - home position")
        jp = tree.computeJointPosition(Joint.RIGHT_HIP_X)
        println(String.format("\t%s (0.0,22.5,0.0) [90,90,180]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_HIP_X)
        println(String.format("\t%s (0.0,-22.5,0.0) [90,90,180] :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_HIP_Z)
        println(String.format("\t%s (0.0,66.5,5.0) [180,90,90]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_HIP_Z)
        println(String.format("\t%s (0.0,-66.5,5.0) [180,90,90] :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_HIP_Y)
        println(String.format("\t%s (0.0,66.5,-29.0) [0,0,0]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_HIP_Y)
        println(String.format("\t%s (0.0,-66.5,-29.0) [0,0,0] :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_KNEE_Y)
        println(String.format("\t%s (0.0,66.5,-211.0) [0,0,0]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_KNEE_Y)
        println(String.format("\t%s (0.0,-66.5,-211.0) [0,0,0] :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_ANKLE_Y)
        println(String.format("\t%s (0.0,66.5,-391.0) [0,0,0]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_ANKLE_Y)
        println(String.format("\t%s (0.0,-66.5,-391.0) [0,0,0] :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_HEEL)
        println(String.format("\t%s (-43.0,78.5,-426.5) [90,0,90]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_HEEL)
        println(String.format("\t%s (-43.0,-78.5,-426.5) [90,0,90] :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_TOE)
        println(String.format("\t%s (95.0,51.5,-426.5) [90,0,90]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_TOE)
        println(String.format("\t%s (95.0,-51.5,-426.5) [90,0,90]  :( %s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
