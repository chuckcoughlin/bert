...
object ChainTest {
    ...
    fun execute() {
        ...
        println(String.format("\tLEFT_SHOULDER_X  = %s ",Solver.computeLocationDescription(Joint.LEFT_SHOULDER_X)))
        println("######## POSITION VERIFIED (6.8, 105.5, 243.5) ####################")
        ...
        println(String.format("\tLEFT_ELBOW_Y     = %s ",Solver.computeLocationDescription(Joint.LEFT_ELBOW_Y)))
