...
object ChainTest {
    ...
    fun execute() {
        ...
        */
        ...
        println(String.format("\t%s (-43.0,78.5,-426.5) [0,0,0]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.LEFT_HEEL)
        println(String.format("\t%s (-43.0,-78.5,-426.5) [0,0,0] :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
        jp = tree.computeJointPosition(Joint.RIGHT_TOE)
        println(String.format("\t%s (95.0,51.5,-426.5) [0,0,0]  :(%s|%s)",jp.joint.name,jp.positionToText(),jp.orientationToText()))
