...
object ChainTest {
    ...
    fun execute() {
        ...
        */
        ...
        var jp = tree.refreshJointPosition(Joint.ABS_Y)
        ...
        jp = tree.refreshJointPosition(Joint.ABS_Y)
