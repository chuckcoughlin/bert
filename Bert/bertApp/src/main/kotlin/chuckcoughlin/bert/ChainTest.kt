...
object ChainTest {
    ...
    fun execute() {
        ...
        println(String.format("\tNECK_Y = %s ", ForwardSolver.computePositionDescription(Joint.NECK_Y.name)))
        println(String.format("\tNOSE   = %s ", ForwardSolver.computePositionDescription(Appendage.NOSE.name)))
        println(String.format("\tLEFT_EAR  = %s ", ForwardSolver.computePositionDescription(Appendage.LEFT_EAR.name)))
        ...
        println(String.format("\tLEFT_SHOULDER_Y  = %s ", ForwardSolver.computePositionDescription(Joint.LEFT_SHOULDER_Y.name)))
