...
The development host is an iMac running OSX Mohave (10.14). The code repository resides on this machine. Code is compiled and downloaded onto the robot target over a WiFi connection using *rsync*.
