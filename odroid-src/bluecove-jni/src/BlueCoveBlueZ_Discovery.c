 ...
 *
 * @version $Id: BlueCoveBlueZ_Discovery.c 2558 2008-12-11 08:25:35Z skarzhevskyy $
 */
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_runDeviceInquiryImpl
...
JNIEXPORT jboolean JNICALL Java_bluecove_core_BluetoothStackBlueZ_deviceInquiryCancelImpl
...
JNIEXPORT jstring JNICALL Java_bluecove_core_BluetoothStackBlueZ_getRemoteDeviceFriendlyNameImpl
...
JNIEXPORT jstring JNICALL Java_bluecove_core_BluetoothStackBlueZ_getRemoteDeviceVersionInfoImpl
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_getRemoteDeviceRSSIImpl
  (JNIEnv *env, jobject peer, jint deviceDescriptor, jlong remoteDeviceAddressLong) {
