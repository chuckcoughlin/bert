...
JNIEXPORT jlong JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2OpenClientConnectionImpl
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2CloseClientConnection
...
JNIEXPORT jboolean JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2Ready
  (JNIEnv* env, jobject peer, jlong handle) {
    struct pollfd fds;
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2Receive
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2Send
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2GetReceiveMTU
  (JNIEnv* env, jobject peer, jlong handle) {
    struct l2cap_options opt;
    if (l2Get_options(env, handle, &opt)) {
        return opt.imtu;
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2GetTransmitMTU
  (JNIEnv* env, jobject peer, jlong handle) {
    struct l2cap_options opt;
    if (l2Get_options(env, handle, &opt)) {
        return opt.omtu;
...
JNIEXPORT jlong JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2RemoteAddress
  (JNIEnv* env, jobject peer, jlong handle) {
    struct sockaddr_l2 remoteAddr;
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2GetSecurityOpt
