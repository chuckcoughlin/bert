...
JNIEXPORT jlong JNICALL Java_bluecove_core_BluetoothStackBlueZ_connectionRfOpenClientConnectionImpl
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_connectionRfCloseClientConnection
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_rfGetSecurityOptImpl
  (JNIEnv *env, jobject peer, jlong handle) {
    int socket_opt = 0;
    socklen_t len = sizeof(socket_opt);
    if (getsockopt(handle, SOL_RFCOMM, RFCOMM_LM, &socket_opt, &len) < 0) {
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_connectionRfRead
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_connectionRfReadAvailable
  (JNIEnv* env, jobject peer, jlong handle) {
    struct pollfd fds;
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_connectionRfWrite__JI
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_connectionRfWrite__J_3BII
  (JNIEnv* env, jobject peer, jlong handle, jbyteArray b, jint off, jint len) {
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_connectionRfFlush
  (JNIEnv* env, jobject peer, jlong handle) {
}

JNIEXPORT jlong JNICALL Java_bluecove_core_BluetoothStackBlueZ_getConnectionRfRemoteAddress
  (JNIEnv* env, jobject peer, jlong handle) {
    struct sockaddr_rc remoteAddr;
