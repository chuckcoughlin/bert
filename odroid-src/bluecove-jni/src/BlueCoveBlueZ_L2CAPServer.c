...
JNIEXPORT jlong JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2ServerOpenImpl
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2ServerGetPSMImpl
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2ServerCloseImpl
...
JNIEXPORT jlong JNICALL Java_bluecove_core_BluetoothStackBlueZ_l2ServerAcceptAndOpenServerConnection
  (JNIEnv* env, jobject peer, jlong handle) {
