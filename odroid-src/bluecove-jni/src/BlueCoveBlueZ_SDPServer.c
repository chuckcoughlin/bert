 ...
 *
 * @version $Id: BlueCoveBlueZ_SDPServer.c 2445 2008-11-11 22:45:22Z minashokry $
 */
...
JNIEXPORT jlong JNICALL Java_bluecove_core_BluetoothStackBlueZ_openSDPSessionImpl
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_closeSDPSessionImpl
...
JNIEXPORT jlong JNICALL Java_bluecove_core_BluetoothStackBlueZ_registerSDPServiceImpl
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_updateSDPServiceImpl
...
JNIEXPORT void JNICALL Java_bluecove_core_BluetoothStackBlueZ_unregisterSDPServiceImpl
  (JNIEnv* env, jobject peer, jlong sdpSessionHandle, jlong localDeviceBTAddress, jlong handle, jbyteArray record) {
    sdp_session_t* session = (sdp_session_t*)jlong2ptr(sdpSessionHandle);
    sdp_record_t *rec;
