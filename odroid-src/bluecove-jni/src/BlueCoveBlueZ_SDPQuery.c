 ...
 *
 * @version $Id: BlueCoveBlueZ_SDPQuery.c 2563 2008-12-11 16:38:02Z skarzhevskyy $
 */
...
JNIEXPORT jint JNICALL Java_bluecove_core_BluetoothStackBlueZ_runSearchServicesImpl
...
JNIEXPORT jboolean JNICALL Java_bluecove_core_BluetoothStackBlueZ_populateServiceRecordAttributeValuesImpl
